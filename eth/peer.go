...
// PeerInfo represents a short summary of the Grosh sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Grosh protocol version negotiated
