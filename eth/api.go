...
// PublicGroshAPI provides an API to access Grosh full node-related
// information.
type PublicGroshAPI struct {
	e *Grosh
}

// NewPublicGroshAPI creates a new Grosh protocol API for full nodes.
func NewPublicGroshAPI(e *Grosh) *PublicGroshAPI {
	return &PublicGroshAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicGroshAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicGroshAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicGroshAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().HashRate())
}

// ChainId is the EIP-155 replay-protection chain id for the current grosh chain config.
func (api *PublicGroshAPI) ChainId() hexutil.Uint64 {
	chainID := new(big.Int)
...
func NewPublicMinerAPI(e *Grosh) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Grosh) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Grosh full node-related APIs
...
// admin methods of the Grosh service.
func NewPrivateAdminAPI(eth *Grosh) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Grosh full node APIs exposed
...
// related public debug methods of the Grosh service.
func NewPublicDebugAPI(eth *Grosh) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Grosh full node APIs exposed over
...
// private debug methods of the Grosh service.
func NewPrivateDebugAPI(eth *Grosh) *PrivateDebugAPI {
