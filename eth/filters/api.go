...
// information related to the Grosh protocol such als blocks, transactions and logs.
...
//
// https://github.com/grosh/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://github.com/grosh/wiki/wiki/JSON-RPC#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(grosh.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as grosh.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria grosh.FilterQuery
...
//
// https://github.com/grosh/wiki/wiki/JSON-RPC#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(grosh.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/grosh/wiki/wiki/JSON-RPC#eth_getlogs
...
//
// https://github.com/grosh/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://github.com/grosh/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://github.com/grosh/wiki/wiki/JSON-RPC#eth_getfilterchanges
