...
type Database struct {
	diskdb grodb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb grodb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb grodb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() grodb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch grodb.Batch, uncacher *cleaner) error {
