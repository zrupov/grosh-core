...
# 1. install grosh for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for grosh
# 5. create grosh, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable GROSH_SOCKET
...
!define GROUPNAME "Grosh"
!define APPNAME "Grosh"
!define DESCRIPTION "Official Go implementation of the Grosh protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since grosh is installed global
