...
// valid Grosh transaction.
type TransactOpts struct {
	From   common.Address // Grosh account to send the transaction from
...
// Grosh network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Grosh blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Grosh methods
...
// DeployContract deploys a contract onto the Grosh blockchain and binds the
...
func (c *BoundContract) Call(opts *CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = grosh.CallMsg{From: opts.From, To: &c.address, Data: input}
...
func (c *BoundContract) transact(opts *TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	...
	if gasLimit == 0 {
		...
		msg := grosh.CallMsg{From: opts.From, To: contract, Value: value, Data: input}
