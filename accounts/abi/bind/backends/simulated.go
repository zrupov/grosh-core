...
func (b *SimulatedBackend) CallContract(ctx context.Context, call grosh.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call grosh.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call grosh.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call grosh.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query grosh.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query grosh.FilterQuery, ch chan<- types.Log) (grosh.Subscription, error) {
