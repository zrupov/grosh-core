...
// Package bind generates grosh contract Go bindings.
//
// Detailed usage document and tutorial available on the go-grosh Wiki page:
// https://github.com/groshproject/grosh-core/wiki/Native-DApps:-Go-bindings-to-Grosh-contracts
package bind
