...
// 2.1.0 (Model T). The Grosh address representation was changed from the 20
...
//go:generate protoc -I/usr/local/include:. --go_out=import_path=trezor:. messages.proto messages-common.proto messages-management.proto messages-grosh.proto
