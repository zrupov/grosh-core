...
// See https://github.com/grosh/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Grosh presale wallet and stores
