...
// the `coin_type` 60' (or 0x8000003C) to Grosh.
//
// The root path for Grosh is m/44'/60'/0'/0 according to the specification
// from https://github.com/grosh/EIPs/issues/84, albeit it's not set in stone
