...
func NewTable(db grodb.Database, prefix string) grodb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() grodb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) grodb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) grodb.Iterator {
...
func (t *table) NewBatch() grodb.Batch {
...
func (b *tableBatch) Replay(w grodb.KeyValueWriter) error {
