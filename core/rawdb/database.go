...
func NewDatabase(db grodb.KeyValueStore) grodb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db grodb.KeyValueStore, freezer string, namespace string) (grodb.Database, error) {
...
func NewMemoryDatabase() grodb.Database {
...
func NewMemoryDatabaseWithCap(size int) grodb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (grodb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (grodb.Database, error) {
...
func InspectDatabase(db grodb.Database) error {
	it := db.NewIterator()
	defer it.Release()
