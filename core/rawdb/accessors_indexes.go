...
func ReadTxLookupEntry(db grodb.Reader, hash common.Hash) *uint64 {
...
func WriteTxLookupEntries(db grodb.KeyValueWriter, block *types.Block) {
...
func DeleteTxLookupEntry(db grodb.KeyValueWriter, hash common.Hash) {
	db.Delete(txLookupKey(hash))
}

// ReadTransaction retrieves a specific transaction from the database, along with
// its added positional metadata.
func ReadTransaction(db grodb.Reader, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
// its added positional metadata.
func ReadReceipt(db grodb.Reader, hash common.Hash, config *params.ChainConfig) (*types.Receipt, common.Hash, uint64, uint64) {
...
func ReadBloomBits(db grodb.KeyValueReader, bit uint, section uint64, head common.Hash) ([]byte, error) {
	return db.Get(bloomBitsKey(bit, section, head))
}

// WriteBloomBits stores the compressed bloom bits vector belonging to the given
// section and bit index.
func WriteBloomBits(db grodb.KeyValueWriter, bit uint, section uint64, head common.Hash, bits []byte) {
