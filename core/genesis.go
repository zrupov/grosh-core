...
func SetupGenesisBlock(db grodb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil)
}

func SetupGenesisBlockWithOverride(db grodb.Database, genesis *Genesis, overrideIstanbul *big.Int) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db grodb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db grodb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db grodb.Database) *types.Block {
...
func GenesisBlockForTesting(db grodb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Grosh main net genesis block.
...
// DeveloperGenesisBlock returns the 'grosh --dev' genesis block. Note, this must
// be seeded with the
