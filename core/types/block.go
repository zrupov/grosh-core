...
// Package types contains data types related to Grosh consensus.
package types
...
// Header represents a block header in the Grosh blockchain.
type Header struct {
...
// Block represents an entire block in the Grosh blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Grosh RLP block format.
