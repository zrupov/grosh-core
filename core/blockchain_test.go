...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (grodb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (grodb.Database, func()) {
...
//
// https://github.com/groshproject/grosh-core/pull/15941
...
//
// Details at:
//  - https://github.com/groshproject/grosh-core/issues/18977
//  - https://github.com/groshproject/grosh-core/pull/18988
