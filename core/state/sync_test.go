...
// account array.
func checkStateAccounts(t *testing.T, db grodb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db grodb.Database, root common.Hash) error {
...
func checkStateConsistency(db grodb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(grodb.Database), srcRoot)
