...
// stateObject represents an grosh account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of grosh address of the account
	data     Account
	db       *StateDB
...
// Account is the grosh consensus representation of accounts.
