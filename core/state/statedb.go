...
// Package state provides a caching layer atop the grosh state trie.
package state
...
// StateDBs within the grosh protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/groshproject/grosh-core/pull/16485#issuecomment-380438527),
