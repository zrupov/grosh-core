...
// setting up a new or managing an existing Grosh private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Grosh private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Grosh network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and grostats servers |")
	...
	log.Info("Administering Grosh network", "name", w.network)
