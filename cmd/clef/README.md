...
This setup allows a DApp to connect to a remote Grosh node and send transactions that are locally signed. This can help in situations when a DApp is connected to an untrusted remote Grosh node, because a local one is not available, not synchronised with the chain, or is a node that has no built-in (or limited) account management.
...
GLOBAL OPTIONS:
   ...
   --keystore value        Directory for the keystore (default: "$HOME/.grosh/keystore")
...
The signer will generate a new private key, encrypts it according to [web3 keystore spec](https://github.com/grosh/wiki/wiki/Web3-Secret-Storage-Definition) and stores it in the keystore directory.
...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/grosh/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP712]([EIP-712](https://github.com/grosh/EIPs/blob/master/EIPS/eip-712.md)) and returns the calculated signature.
...
#### Arguments
  - account [object]: key in [web3 keystore format](https://github.com/grosh/wiki/wiki/Web3-Secret-Storage-Definition) (retrieved with account_export)
...
#### Result
  - exported key, see [web3 keystore format](https://github.com/grosh/wiki/wiki/Web3-Secret-Storage-Definition) for
  more information
  ...
  "params": [
    {
      "accounts": [
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.grosh/keystore/UTC--2017-11-20T14-44-54.089682944Z--123409812340981234098123409812deadbeef42",
          "address": "0x123409812340981234098123409812deadbeef42"
        },
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.grosh/keystore/UTC--2017-11-23T21-59-03.199240693Z--cafebabedeadbeef34098123409812deadbeef42",
...
* A Graphical UI MUST show the blocky-identicon for grosh addresses.
