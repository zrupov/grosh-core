...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Grosh presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    grosh wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Grosh presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	grosh wallet [options] /path/to/my/presale.wallet
...
between grosh nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    grosh account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    grosh account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another grosh instance,
