...
import (
	...
	"github.com/groshproject/grosh-core/internal/cmdtest"
	"github.com/groshproject/grosh-core/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "grosh-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "grosh-test" in runGeth.
	reexec.Register("grosh-test", func() {
...
// spawns grosh with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "grosh". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("grosh-test", args...)
