...
var (
	...
	MainnetCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0xf7b9bc720335b5461b0269c279d93ea11f5a283c"),
		Signers: []common.Address{
			common.HexToAddress("0xe046add00e32b0212ef8d5253729d48b10a12f13"), // Grosh1
...
//			common.HexToAddress("0x0DF8fa387C602AE62559cC4aFa4972A7045d6707"), // Guillaume
	...
	// and accepted by the Grosh core developers into the Ethash consensus.
	//
	...
	// and accepted by the Grosh core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/grosh/EIPs/issues/150)
