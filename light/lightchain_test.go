...
func makeHeaderChain(parent *types.Header, n int, db grodb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (grodb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() grodb.Database {
	return odr.db
}
