 ...
 * @author Gary Rong<garyrong@grosh.org>, Martin Swende <martin.swende@grosh.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the grosh.
    uint sectionSize;
