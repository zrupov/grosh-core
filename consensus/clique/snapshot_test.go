...
// mapped from textual names used in the tests below to actual Grosh private
...
// address retrieves the Grosh address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Grosh address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/groshproject/grosh-core/issues/17593). Whilst this
