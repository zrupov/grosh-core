...
import (
	...
	"github.com/groshproject/grosh-core/consensus/misc"
...
// ecrecover extracts the Grosh account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Grosh address
...
// Grosh testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     grodb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Grosh address of the signing key
...
func New(config *params.CliqueConfig, db grodb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Grosh address recovered
