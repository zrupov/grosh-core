...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db grodb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db grodb.Database) error {
