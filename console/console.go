...
import (
	...
	"github.com/groshproject/grosh-core/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Grosh requests through
...
func (c *Console) Welcome() {
	message := "Welcome to the Grosh JavaScript console!\n\n"
