...
type accessTestFn func(db grodb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }
func TestBlockAccessLes3(t *testing.T) { testAccess(t, 3, tfBlockAccess) }

func tfBlockAccess(db grodb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db grodb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db grodb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db grodb.Database, bhash common.Hash, num uint64) light.OdrRequest {
